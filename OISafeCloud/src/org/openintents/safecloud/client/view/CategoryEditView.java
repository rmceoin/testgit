 ...
 * 
 */
public class CategoryEditView extends Composite implements
    CategoryEditPresenter.Display {

  private static CategoryEditUiBinder uiBinder = GWT
      .create(CategoryEditUiBinder.class);

  interface CategoryEditUiBinder extends UiBinder<Widget, CategoryEditView> {
  }

  @UiField
  TextBox categoryNameField, lastNameField, emailField, url;
  @UiField
  ...
  protected void onLoad() {
    super.onLoad();
    categoryNameField.setFocus(true);
  }
  ...
  @Override
  public HasValue<String> getCategoryName() {
