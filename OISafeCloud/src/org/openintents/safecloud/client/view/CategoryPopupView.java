...
/**
 * A simple popup that displays category's info w/ edit / delete buttons.
 */
public class CategoryPopupView extends PopupPanel implements CategoryPopupPresenter.Display {
  @UiTemplate("CategoryPopupView.ui.xml")
  interface Binder extends UiBinder<Widget, CategoryPopupView> {
  }
  ...
  public CategoryPopupView(String displayName, ClickPoint location) {
    this();
    setNameAndShow(displayName, location);
  }

  public CategoryPopupView(SafeCategory category) {
    this();
  ...
  @Override
  public HasText getCategoryNameLabel() {
